...
if __name__ == '__main__':
    ...
    # First hidden layer - wider than your current one
    net.add(DenseLayer(64, (n_features,), init_weights="he"))
    net.add(ReLUActivation())
    net.add(DropoutLayer(dropout_rate=0.2))

    # Second hidden layer
    net.add(DenseLayer(32, init_weights="he"))
    net.add(ReLUActivation())
    net.add(DropoutLayer(dropout_rate=0.2))

    # Output layer
    net.add(DenseLayer(1, init_weights="xavier")) 
